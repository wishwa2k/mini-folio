...
const Projects = () => {
    ...
    items-center justify-center gap-20 p-10 md:p-16 xl:px-32'>
            ...
            border-teal-500 rounded-lg hover:bg-teal-50">
                    ...
                    <p className='text-sm text-gray-600'>Neque porro quisquam est qui dolorem ipsum quia dolor
                        sit amet, consectetur, adipisci velit Lorem Ipsum is sit
                        of the printing </p>
                </div>
